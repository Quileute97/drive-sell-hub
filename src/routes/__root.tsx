  ...
  head: () => ({
    meta: [
      ...
      { title: "Salemylink - Marketplace Ebook, Tài Liệu Học Tập & Khóa Học Online | Việt Nam" },
      {
        name: "description",
        content:
          "Salemylink - Nền tảng mua bán tài liệu số, ebook, khóa học trực tuyến qua Google Drive uy tín hàng đầu Việt Nam. Tải xuống tức thì, thanh toán an toàn.",
      },
      { name: "author", content: "Salemylink.com" },
      {
        name: "keywords",
        content:
          "bán sản phẩm digital, ebook việt nam, tài liệu digital, khóa học online, google drive, thương mại điện tử, marketplace digital, bán tài liệu online, tài liệu y khoa, đề thi",
      },
      ...
      { property: "og:image:height", content: "630" },
      {
        ...
        content: "Salemylink - Marketplace Ebook, Tài Liệu Học Tập & Khóa Học Online",
      },
